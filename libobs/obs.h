...
//extend by wyb
EXPORT void obs_source_show_force(obs_source_t *source);
EXPORT void obs_source_hide_force(obs_source_t *source);
EXPORT const char *obs_source_get_app_encodedId(const obs_source_t *source, void *hwnd);
